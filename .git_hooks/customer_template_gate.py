...
This gate fails a commit or a push when one of the six words below appears in
...
WORDS = ("meldloket", "postedworkers", "mfnl", "p652", "barney", "cuneus")
WORD_RE = re.compile("|".join(WORDS), re.IGNORECASE)
ALLOW = "customer-template: allow"

# The shared trees a tenant, an author or the next platform change reads.
SCOPES = (
    "oteny_shortcut", "oteny_audit", "oteny_backup_trigger", "oteny_bot", "riverflow",
    "odoo_parallel_tests", "oteny_knowledge_sync", "talents",
)
